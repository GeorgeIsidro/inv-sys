...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($count > 0) {
        ...
        try {
            ...
            $stmt->execute([$itemName, $purchaseDate, $deliveryDate, $propertyNumber, $serialNumber, $modelNumber, $description, $manufacturerName, $quantityBought, $designation, $receivedBy, $supplierName, $orNumber, $amount, $transferHistory, $orderedBy, $requestingPerson, $orderingPerson, $receiptLink, $issuanceDate, $assignedOffice, $remarks]);
