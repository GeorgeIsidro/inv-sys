...
<body>
  ...
  <form action="insert_item.php" method="post">
	...
	<label for="quantity_assigned">Quantity Assigned:</label>
	<input type="number" name="quantity_assigned" required>
    ...
    <input type="text" class="form-control" id="transfer_history" name="transfer_history" required>
    ...
    <input type="text" class="form-control" id="assigned_office" name="assigned_office" required>
