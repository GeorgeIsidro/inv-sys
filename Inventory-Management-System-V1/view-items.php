...
if (isset($_POST['search'])) {
    ...
    $stmt = $conn->prepare("SELECT * FROM inventory WHERE item_name LIKE ? OR ordered_by LIKE ? OR property_number LIKE ? OR designation LIKE ? OR manufacturer_name LIKE ? OR YEAR(purchase_date) = ?");
